        ...
        <View style={styles.inspirationContent}>
            ...
            <View style={styles.randomContainer}>
                {cocktails.map((cocktail, index) => (
                    <TouchableOpacity key={cocktail.id} style={styles.containerCocktail} onPress={() => navigation.navigate('Cocktails', { screen: 'Informations Cocktail', params: { cocktailId: cocktail.id } })}>
